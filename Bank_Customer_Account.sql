...
Insert Into Account_Type Values(1,'Debit'),(2,'Creadit')
update Account_Type set acctype_id=222 where acctype_id=1
update Account_Type set acctype_id=333 where acctype_id=2
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Insert Into Transactions Values(901,70071,40000,333,'2023-06-07'),(902,70072,50000,222,'2023-03-05'),(903,70073,100000,333,'2023-01-02'),
(904,70074,200000,222,'2023-04-08'),(905,70075,60000,333,'2023-11-05'),(906,70076,3000,333,'2033-06-09')

update Transactions set Transaction_Type='credit' where Transaction_Type=222

update Transactions set Transaction_Type='Debit' where Transaction_Type=333
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 Insert Into Customer_Master Values(104,'sandep Pagare',8877553300,29,'SHDBC8999J')
 
 Delete Customer_Master where Cust_id=104 
 Select * from Bank
